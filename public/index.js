...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        ...
        this._alert = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel("Alert") });
        this._line3 = new qinpel_cps_1.QinLine({ items: [this._alert] });
