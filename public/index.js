...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this._btnInfo = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel(this.qinpel.tr("Show Info")) });
        this._btnError = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel(this.qinpel.tr("Show Error")) });
        ...
        this._btnInfo.addActionMain(() => {
            this.qinpel.jobbed.showInfo(this.qinpel.tr("This is a info with a origin"), "{qinscaffold}(ErrCode-000002)");
        });
        this._btnError.addActionMain(() => {
            this.qinpel.jobbed.showError({ why: this.qinpel.tr("This an error with a reason") }, "{qinscaffold}(ErrCode-000001)");
        });
    }
}
