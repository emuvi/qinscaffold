...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this._button = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel("Get Row 3") });
        this._line1 = new qinpel_cps_1.QinLine({ items: [this._button] });
        this._table = new qinpel_cps_1.QinTable();
        this._line2 = new qinpel_cps_1.QinLine({ items: [this._table] });
