...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        ...
        this._dialog = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel("Dialog") });
        this._line3 = new qinpel_cps_1.QinLine({ items: [this._dialog] });
