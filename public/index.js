...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this._btnInfo = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel("Show Info") }).styled({
            width: "800px",
        });
