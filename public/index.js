...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this._edit = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel("Edit") });
        this._read = new qinpel_cps_1.QinButton({ label: new qinpel_cps_1.QinLabel("Read") });
        this._line1 = new qinpel_cps_1.QinLine({ items: [this._edit, this._read] });
        this._int = new qinpel_cps_1.QinInteger();
        this._str = new qinpel_cps_1.QinString();
        this._line2 = new qinpel_cps_1.QinLine({ items: [this._int, this._str] });
