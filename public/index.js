...
class QinScaffold extends qinpel_cps_1.QinColumn {
    constructor() {
        ...
        this._btnInfo.addActionMain(() => {
            this.qinpel.jobbed.showInfo("This is a info with a origin", "{qinscaffold}(ErrCode-000002)");
        });
